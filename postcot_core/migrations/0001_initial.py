# Generated by Django 2.0.6 on 2018-06-13 01:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phase', enumfields.fields.EnumField(enum=postcot_core.base_types.AccessControlPhase, max_length=1)),
                ('input_kind', enumfields.fields.EnumField(enum=postcot_core.base_types.AccessControlInputKind, max_length=1)),
