# Generated by Django 2.0.6 on 2018-06-08 15:19

from django.db import migrations, models
import django.db.models.deletion
import postcot_primary.base_types
import postcot_primary.validators.action_validator
import postcot_primary.validators.domain_validator
import postcot_primary.validators.postfix_identifier_validator
import postcot_primary.validators.username_pattern_validator
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.TextField(help_text='Cannot edit after created.', unique=True, validators=[postcot_primary.validators.action_validator.ActionValidator()])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subject_role', enumfields.fields.EnumField(enum=postcot_primary.base_types.AccessControlRole, max_length=1)),
                ('subject_content', enumfields.fields.EnumField(enum=postcot_primary.base_types.AccessControlContent, max_length=1)),
                ('reverses_hostname', models.BooleanField(max_length=1)),
                ('postfix_identifier', models.CharField(max_length=256, validators=[postcot_primary.validators.postfix_identifier_validator.PostfixIdentifierValidator()])),
                ...
                ('action', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='access_controls', to='postcot.AccessAction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alias_name', models.CharField(max_length=256, validators=[postcot_primary.validators.username_pattern_validator.UsernamePatternValidator()], verbose_name='Name')),
                ('notes', models.CharField(blank=True, help_text='Notes on the alias.', max_length=256, null=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aliases', to='postcot.Account')),
            ],
            options={
                'verbose_name': 'Alias',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('domain_name', models.CharField(max_length=256, validators=[postcot_primary.validators.domain_validator.DomainValidator()], verbose_name='Name')),
        ...
        migrations.AddField(
            model_name='account',
            name='domain',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='accounts', to='postcot.Domain'),
        ),
    ]
